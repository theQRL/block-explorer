...
Template.address.helpers({
  ...
  validAddress() {
    ...
    if (validationResult.result === true) {
      ...
      const thisOtsBitfield = Session.get('address').ots_bit_field
    ...
    if (result.validator.sig.result === true) { result.validator.sig.class = 'fa-check text-success' } else { result.validator.sig.class = 'fa-times text-danger' }
    if (result.validator.len.result === true) { result.validator.len.class = 'fa-check text-success' } else { result.validator.len.class = 'fa-times text-danger' }
    if (result.validator.hash.result === true) { result.validator.hash.class = 'fa-check text-success' } else { result.validator.hash.class = 'fa-times text-danger' }
    if (result.validator.checksum.result === true) { result.validator.checksum.class = 'fa-check text-success' } else { result.validator.checksum.class = 'fa-times text-danger' }
